...
public sealed class Serializable
{
    ...
    public int? PascalProp { get; set; }
    public int? camelProp { get; set; }
    public int? Snake_Prop { get; set; }
    public int? SNAKE_UPPER { get; set; }
    public int? snake_lower { get; set; }
    ...
    public int? Version_1_2 { get; set; }
    public int? Version__1_3 { get; set; }
    public int? Version2Alpha { get; set; }
